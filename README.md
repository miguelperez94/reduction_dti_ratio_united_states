...
The [document](https://github.com/miguelperez94/reduction_dti_ratio_united_states/blob/main/static_final/final_version.pdf) analyses the generalized reduction in the household debt-to-income 
...
changes in debt-to-income ratios were more concentrated by richer counties,
...
ratios at the state and county level provided by the Enhanced Financial Accounts initiative
(EFA). That data was obtained from https://www.federalreserve.gov/ and is used in all the
data analysis through the project.

The secondary sources for the analysis are:
